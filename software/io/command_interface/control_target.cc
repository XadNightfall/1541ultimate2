        ...
        case CTRL_CMD_GET_HWINFO: {
            ...
            else
            {
               ...
               else if (device == 1)
               {
               	    ...
               	    data_message.length = 10 + (C64_SID1_EN_BAK ? 5 : 0) + (C64_SID2_EN_BAK ? 5 : 0);
                    ...
                    if ( C64_SID1_EN_BAK )
                    {
                        ...
                        {
                           data[13] = data[11];
                           data[14] = data[12] | (C64_STEREO_ADDRSEL_BAK ? 0x20: 0x100);
                        }
                    ...
                    if ( C64_SID2_EN_BAK )
                    {
                        ...
                        {
                           data[13+ofsTmp] = data[11+ofsTmp];
                           data[14+ofsTmp] = data[12+ofsTmp] | (C64_STEREO_ADDRSEL_BAK ? 0x20: 0x100);
                        }
